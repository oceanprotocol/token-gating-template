...
const Wrapper: NextPage<WrapperPropType> = ({
  show,
  price,
  unlock,
  loading,
  ...
  const { getServicePrice, hasSufficientFunds, hasFunds } =
    useAssetOwnershipContext();

  useEffect(() => {
    (async () => {
      await hasSufficientFunds(price);
    })();
  }, [loading]);
        ...
        <div className={cs(style.body, 'w-100')}>
          ...
          >
            <div className="d-flex flex-column align-items-start col-12 col-md-8">
              ...
              <div className="mt-1 UrbanistRegular20 text-white">
                Pay now to access the premium content
              </div>
              ...
              <div className="my-3 UrbanistExtraLight16 colorGreyLighter text-start">
                *For using this dataset, you will buy 1 DELPRA-26 and
                immediately spend it back to the publisher.
              </div>
              {loading ? (
              ...
              {!hasFunds ? (
                <div className="my-2 UrbanistExtraLight16 colorGreyLighter">
