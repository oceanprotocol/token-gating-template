...
export interface TokenPriceQueryTokenOrdersReuses {
...
export interface TokenPriceQuery_token_orders {
  ...
  reuses: TokenPriceQueryTokenOrdersReuses[] | null;
}
...
export interface TokenPriceQuery_token_dispensers {
  ...
  /**
   * max balance of requester. If the balance is higher, the dispensed is rejected
   */
  maxBalance: any;
...
export interface TokenPriceQueryToken {
  __typename: 'Token';
  id: string;
  symbol: string | null;
  name: string | null;
...
export interface TokenPriceQuery {
  token: TokenPriceQueryToken | null;
}
